...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        requestButton->setGeometry(QRect(650, 210, 131, 31));
        ...
        contExe = new QPushButton(centralWidget);
        contExe->setObjectName(QStringLiteral("contExe"));
        contExe->setGeometry(QRect(650, 330, 131, 31));
        RegisterViewer = new QTextBrowser(centralWidget);
        RegisterViewer->setObjectName(QStringLiteral("RegisterViewer"));
        RegisterViewer->setGeometry(QRect(820, 70, 191, 381));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(820, 30, 161, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        signalSelector->insertItems(0, QStringList()
         ...
         << QApplication::translate("MainWindow", "Rg: registro 0", 0)
        );
        ...
        contExe->setText(QApplication::translate("MainWindow", "Start continue execution", 0));
        label_2->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Registros:</span></p></body></html>", 0));
    } // retranslateUi
